...
- Feature `wdk-alloc-align` enables over-aligned allocations in `WdkAllocator` by padding and storing the base pointer.
- Default remains a hard 16-byte cap for minimal overhead.
